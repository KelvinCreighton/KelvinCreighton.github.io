...
export default function RcCarProject() {
  ...
  const controllerSteps: Step[] = [
    ...
    { number: 18, text: "Take the rest of the popsicle sticks left and snap off two small parts and tack them with hot glue", image: "/images/projects/rc-car-pdf/img-p40-7.jpg", orientation: "horizontal" },
    { number: 19, text: "Then hot glue stack to the left of the box.", image: "/images/projects/rc-car-pdf/img-p40-8.jpg", orientation: "horizontal" },
    { number: 20, text: "Use some electrical tape to attach the red wire to the positive + side of the battery and the black wire to the negative - side.", image: "/images/projects/rc-car-pdf/img-p40-9.jpg", orientation: "horizontal" },
    { number: 21, text: "Place the battery on the right side of the box.", image: "/images/projects/rc-car-pdf/img-p41-7.jpg", orientation: "horizontal" },
    { number: 22, text: "Place in the transmitter circuit. Open the brass fasteners to hold the circuit in place.", image: "/images/projects/rc-car-pdf/img-p41-8.jpg", orientation: "horizontal" },
    { number: 23, text: "Now the entire project is done!!!", image: "/images/projects/rc-car-pdf/img-p41-10.jpg", orientation: "horizontal" },
  ];
