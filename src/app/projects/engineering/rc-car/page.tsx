...
export default function RcCarProject() {
  const carSteps: Step[] = [
    ...
    { number: 3, text: "Take the last large popsicle stick and snap it in half too", image: "/images/projects/rc-car-pdf/img-p12-7.jpg", orientation: "vertical" },
    { number: 4, isHalfWidth: true, text: "Lay the large 3d printed wheel and motor from the bottom of the box. Lastly lay and hot glue the half popsicle stick across. \nOr use a ruler and measure around 8cm to 9cm where it should lay. \nMAKE SURE: the 3rd half that is glued in the center is also on top of the longer pieces. all the halves should be level with each other.", image: "/images/projects/rc-car-pdf/img-p12-8.jpg", orientation: "vertical" },
    ...
    { number: 17, text: "Slide the 3d printed wheel on", image: "/images/projects/rc-car-pdf/img-p17-9.jpg", orientation: "horizontal" },
    { number: 18, text: "Slide the last straw piece and then attach the last wheel", image: "/images/projects/rc-car-pdf/img-p18-7.jpg", orientation: "horizontal" },
    { number: 19, text: "Now you should have 2 sets of wheels ready for assembly.", image: "/images/projects/rc-car-pdf/img-p18-9.jpg", orientation: "horizontal" },
    ...
    { number: 27, text: "Twist the red and black wires together from the battery hub and the RF receiver circuit.", image: "/images/projects/rc-car-pdf/img-p23-7.jpg", orientation: "vertical" },
    { number: 28, text: "Add electrical tape to the ends so they cannot touch and short circuit", image: "/images/projects/rc-car-pdf/img-p23-8.jpg", orientation: "vertical" },
    ...
    { number: 31, text: "Now we are going to check that everything was connected properly before continuing with the rest of the car. \nPut in the batteries and flip the red switch on the circuit board. The red leds should light up meaning it has power", image: "/images/projects/rc-car-pdf/img-p25-7.jpg", orientation: "horizontal" },
    { number: 32, text: "Next take the 3v coin battery and the RF Transmitter circuit board and hold the negative and positive wires to the battery \nRed wire goes to the side of the battery with the “+” sign and Black wire goes to the other side of the battery", image: "/images/projects/rc-car-pdf/img-p25-8.jpg", orientation: "vertical" },
    { number: 33, text: "When pressing the button labelled F or B you should see the red light up on the Transmitter circuit board.", image: "/images/projects/rc-car-pdf/img-p26-7.jpg", orientation: "vertical" },
    ...
    { number: 40, text: "Once everything is in place and positioned evenly / centered. add a bit of hot glue to the 3d printed wheel and the skewer to attach them properly. \nOnly add a little bit in case you end up needing to take this part off to replace the elastic in the future.", image: "/images/projects/rc-car-pdf/img-p29-8.jpg", orientation: "horizontal" },
    { number: 41, text: "THE CAR IS DONE!!!!! \nFeel free to test it with the RF Transmitter circuit board like was done to test the connections earlier in the step-by-step. \n\nNOW on to part 2: the controller", image: "/images/projects/rc-car-pdf/img-p30-7.jpg", orientation: "vertical" },
    { number: 42, text: "OPTIONAL: \nAdditionally feel free to add a bumper to the front of the car so it has support when it crashes into a wall. \nFirst cut the straw in half. Another camper will use the other half", image: "/images/projects/rc-car-pdf/img-p30-8.jpg", orientation: "horizontal" },
    { number: 43, text: "Then cut the straw open, as straight as possible", image: "/images/projects/rc-car-pdf/img-p31-7.jpg", orientation: "horizontal" },
    { number: 44, text: "Attach it to the front of the car and hot glue it down", image: "/images/projects/rc-car-pdf/img-p31-8.jpg", orientation: "horizontal" },
  ];

  const controllerSteps: Step[] = [
    { number: 1, text: "Now the next part is to create the controller. \n\nRefer to the Project Overview for the required electronics and assembly tools.", image: "/images/projects/rc-car-pdf/img-p32-7.jpg", orientation: "horizontal" },
    { number: 2, text: "First take the stiffer wire (one that is harder to bend) and strip a bit off one of the ends. \nDo the same with the other side but strip a lot more off.", image: "/images/projects/rc-car-pdf/img-p32-8.jpg", orientation: "horizontal" },
    { number: 3, text: "Verify that the skewer is exactly 3.8mm to 4mm diameter.", image: "/images/projects/rc-car-pdf/img-p33-7.jpg", orientation: "horizontal" },
    { number: 4, isHalfWidth: true, text: "Take the skewer and wrap the wire with the longer stripped side around it.", image: "/images/projects/rc-car-pdf/img-p33-8.jpg", orientation: "horizontal" },
    { number: 5, isHalfWidth: true, text: "Take it off the skewer and press the circles together so it forms a coil. This will be the antenna for the controller.", image: "/images/projects/rc-car-pdf/img-p34-7.jpg", orientation: "horizontal" },
    { number: 6, isHalfWidth: true, text: "Find the large ANT hole (antenna connection hole) and locate the smaller hole beside it (also an antenna connection hole)", image: "/images/projects/rc-car-pdf/img-p34-8.jpg", orientation: "vertical" },
    { number: 7, isHalfWidth: true, text: "Have an instructor solder the antenna wire in this hole. This should be the only soldering you will need to do. \nIf you do not solder this it is likely not going to work. \n(Yes I tried attaching it to the resistor) \nIf a camper really knows how to solder without issue maybe let them do it. I’ll leave this up to the senior instructor's judgment call.", image: "/images/projects/rc-car-pdf/img-p34-9.jpg", orientation: "vertical" },
    { number: 8, text: "Hot glue the base of the Red and Black wires. This will help them stay attached better.", image: "/images/projects/rc-car-pdf/img-p35-7.jpg", orientation: "vertical" },
    { number: 9, text: "Strip the ends of the wires to a decent length.", image: "/images/projects/rc-car-pdf/img-p36-7.jpg", orientation: "vertical" },
    { number: 10, text: "Slide the Red and Black wires through the hole in the center.", image: "/images/projects/rc-car-pdf/img-p36-8.jpg", orientation: "horizontal" },
    { number: 11, text: "Take the jumbo popsicle stick and snap it in half", image: "/images/projects/rc-car-pdf/img-p36-9.jpg", orientation: "horizontal" },
    { number: 12, text: "Trim the ends with some scissors", image: "/images/projects/rc-car-pdf/img-p36-10.jpg", orientation: "horizontal" },
    ...
    { number: 14, text: "Cut a regular popsicle stick the the size of the width of the two jumbo popsicle sticks", image: "/images/projects/rc-car-pdf/img-p37-8.jpg", orientation: "vertical" },
    { number: 15, text: "Trim these also", image: "/images/projects/rc-car-pdf/img-p37-9.jpg", orientation: "horizontal" },
    { number: 16, text: "Lay the transmitter circuit down for reference. Then hot glue the regular popsicle sticks on the sides.", image: "/images/projects/rc-car-pdf/img-p38-7.jpg", orientation: "horizontal" },
    { number: 17, text: "Do the same with the other sides", image: "/images/projects/rc-car-pdf/img-p38-8.jpg", orientation: "horizontal" },
    ...
    { number: 19, text: "Twist the left brass fastener 90 degrees", image: "/images/projects/rc-car-pdf/img-p39-7.jpg", orientation: "horizontal" },
        ...
        <div className="w-full prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800 mb-12">
             <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="relative bg-gray-100 dark:bg-gray-800/50 aspect-video">
                   <Image
