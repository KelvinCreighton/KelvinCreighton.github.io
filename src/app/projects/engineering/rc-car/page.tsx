...
{ number: 22, text: "Hot glue the battery holder to the car structure filling the gap on the left. \nmake sure the wires facing out from the car and do not interfere with the motor", image: "/images/projects/rc-car-pdf/img-p20-8.jpg", orientation: "vertical" },
...
{ number: 26, text: "Twist the red and black wires together from the battery hub and the RF receiver circuit.", image: "/images/projects/rc-car-pdf/img-p23-8.jpg", orientation: "vertical" },
{ number: 27, text: "Add electrical tape to the ends so they cannot touch and short circuit", image: "/images/projects/rc-car-pdf/img-p24-7.jpg", orientation: "vertical" },
{ number: 28, text: "Thread the wires through the holes of the motor and twist them so they stay as best as they can \nMAKE SURE YOU PUT THE WIRES IN THIS ORDER. If you don’t then the controls will be inverted (forward is backward and backward is forward) which is not a huge problem but if it can be avoided then great.", image: "/images/projects/rc-car-pdf/img-p24-8.jpg", orientation: "vertical" },
{ number: 29, text: "Carefully hot glue them so they stay attached better. \nIf some campers are comfortable with soldering then they can do that (especially if the connections are having issues) \nIf this is not done right then this can be a failure point of the project. As a last resort just solder them.", image: "/images/projects/rc-car-pdf/img-p25-7.jpg", orientation: "vertical" },
{ number: 30, text: "Now we are going to check that everything was connected properly before continuing with the rest of the car. \nPut in the batteries and flip the red switch on the circuit board. The red leds should light up meaning it has power", image: "/images/projects/rc-car-pdf/img-p25-8.jpg", orientation: "vertical" },
{ number: 31, text: "Next take the 3v coin battery and the RF Transmitter circuit board and hold the negative and positive wires to the battery \nRed wire goes to the side of the battery with the “+” sign and Black wire goes to the other side of the battery", image: "/images/projects/rc-car-pdf/img-p26-7.jpg", orientation: "horizontal" },
{ number: 32, text: "When pressing the button labelled F or B you should see the red light up on the Transmitter circuit board.", image: "/images/projects/rc-car-pdf/img-p26-8.jpg", orientation: "vertical" },
{ number: 33, text: "Hold each part close together and you should see the motor spin when pressing F or B. \nIF IT DOESN’T WORK: \n- Try pressing it a few times and move the transmitter board around, there may be something blocking the wireless connection or there may be some external interference \n- Have each kid try one at a time, the boards are likely the same frequency so they may interfere with each other \n- Try reattaching the wires connected to the motor. since the red leds are on then the board has power it is just not connecting to the motor. \n- Try with a different motor, different receiver board, or different transmitter board", image: "/images/projects/rc-car-pdf/img-p27-7.jpg", orientation: "vertical" },
{ number: 34, text: "Use electrical tape to hold the longer white wire allowing it to face upward to the sky. \nThis wire is the antenna and having it face UP will help the wireless connection", image: "/images/projects/rc-car-pdf/img-p27-8.jpg", orientation: "vertical" },
{ number: 35, text: "Flip the car over gently and hot glue the back wheels across the back half popsicle stick. \nONLY HOT GLUE THE STRAW NEVER THE SKEWER OR WHEELS", image: "/images/projects/rc-car-pdf/img-p28-7.jpg", orientation: "vertical" },
{ number: 36, text: "Do the same with the front wheels. \nAGAIN ONLY HOT GLUE THE STRAW PARTS. \nMake sure no hot glue touches anything else this is very important to the movement of the wheels \nAdditionally make sure the 3d printed wheel does not touch anything even when it wiggles a little. Anything touching it will give it friction and could make it not more properly. \nKeep it as straight as possible", image: "/images/projects/rc-car-pdf/img-p28-8.jpg", orientation: "vertical" },
{ number: 37, text: "(Optional) Add tape after hot glueing the straws down to reinforce them.", image: "/images/projects/rc-car-pdf/img-p29-7.jpg", orientation: "vertical" },
{ number: 38, text: "Flip the car back over. \nUse the elastic tool to grab the elastic out of the 3d printed wheel. And attach it to the motor", image: "/images/projects/rc-car-pdf/img-p29-8.jpg", orientation: "vertical" },
{ number: 39, text: "Once everything is in place and positioned evenly / centered. add a bit of hot glue to the 3d printed wheel and the skewer to attach them properly. \nOnly add a little bit in case you end up needing to take this part off to replace the elastic in the future.", image: "/images/projects/rc-car-pdf/img-p30-7.jpg", orientation: "vertical" },
{ number: 40, text: "THE CAR IS DONE!!!!! \nFeel free to test it with the RF Transmitter circuit board like was done to test the connections earlier in the step-by-step. \n\nNOW on to part 2: the controller", image: "/images/projects/rc-car-pdf/img-p30-8.jpg", orientation: "vertical" },
{ number: 41, text: "OPTIONAL: \nAdditionally feel free to add a bumper to the front of the car so it has support when it crashes into a wall. \nFirst cut the straw in half. Another camper will use the other half", image: "/images/projects/rc-car-pdf/img-p31-7.jpg", orientation: "vertical" },
{ number: 42, text: "Then cut the straw open, as straight as possible", image: "/images/projects/rc-car-pdf/img-p31-8.jpg", orientation: "vertical" },
{ number: 43, text: "Attach it to the front of the car and hot glue it down", image: "/images/projects/rc-car-pdf/img-p31-10.jpg", orientation: "vertical" }
  ];

  const controllerSteps: Step[] = [
    { number: 1, customCrop: "aspect-[3/4]", text: "Now the next part is to create the controller. \nMaterials you will need: \n- RF Transmitter \n- Stiff copper wire (12cm) \n- CR2032 coin battery \n- 2 brass fasteners \n\nTools you will need: \n- Wire strippers \n- Skewer (3.8mm to 4mm diameter no larger no smaller) \n- hot glue \n- ruler and/or caliper \n- tape", image: "/images/projects/rc-car-pdf/img-p32-7.jpg", orientation: "vertical" },
    { number: 2, customCrop: "aspect-[3/4]", text: "First take the stiffer wire (one that is harder to bend) and strip a bit off one of the ends. \nDo the same with the other side but strip a lot more off.", image: "/images/projects/rc-car-pdf/img-p32-8.jpg", orientation: "vertical" },
    { number: 3, customCrop: "aspect-[3/4]", text: "Verify that the skewer is exactly 3.8mm to 4mm diameter.", image: "/images/projects/rc-car-pdf/img-p33-7.jpg", orientation: "vertical" },
    { number: 4, text: "Take the skewer and wrap the wire with the longer stripped side around it.", image: "/images/projects/rc-car-pdf/img-p33-8.jpg", orientation: "vertical" },
    { number: 5, text: "Take it off the skewer and press the circles together so it forms a coil. This will be the antenna for the controller.", image: "/images/projects/rc-car-pdf/img-p34-7.jpg", orientation: "vertical" },
    { number: 6, text: "Find the large ANT hole (antenna connection hole) and locate the smaller hole beside it (also an antenna connection hole)", image: "/images/projects/rc-car-pdf/img-p34-8.jpg", orientation: "vertical" },
    ...
    { number: 15, customCrop: "aspect-[4/3]", objectPosition: "center 60%", text: "Trim these also", image: "/images/projects/rc-car-pdf/img-p37-9.jpg", orientation: "horizontal" },
    { number: 16, customCrop: "aspect-[4/3]", text: "Lay the transmitter circuit down for reference. Then hot glue the regular popsicle sticks on the sides.", image: "/images/projects/rc-car-pdf/img-p38-7.jpg", orientation: "horizontal" },
        ...
        <div className="w-full prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800 mb-12">
             <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="relative aspect-video bg-gray-100 dark:bg-gray-800/50">
                   <Image src="/images/projects/rc-car-pdf/img-p10-7.jpg" alt="Car Materials" fill className="object-contain p-4" />
                </div>
          ...
          <p>The final design was the result of 6 major iterations, refining chassis stability and axle friction.</p>
