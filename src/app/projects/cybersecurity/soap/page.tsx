        ...
        steps: [
          {
            ...
            prose: 'Using Burp Suite to intercept traffic, we observe the outgoing and incoming requests involving an XML payload.',
...
University in Kigali, Rwanda offereing MSECE, MSIT and MS EAI`,
            reason: '<strong>Reason:</strong> The application takes XML input (`ID`), processes it, and reflects content back based on that ID. Since it processes XML without sanitization, it may be vulnerable to XXE (XML External Entity) Injection.',
          },
        ],
      },
      {
        title: 'Creating the Payload',
        prose: 'We can construct an XXE payload to instruct the XML parser to fetch the contents of a local file on the server.',
        steps: [
          {
            number: '01',
