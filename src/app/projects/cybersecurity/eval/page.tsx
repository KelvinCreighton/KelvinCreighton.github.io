        ...
        steps: [
          {
            ...
            output: `os`,
            reason:
              "<strong>Reason:</strong> A trick we can use is through the `chr()` function to evaluate the letters. This outputs `os`, but it is still just a string object.",
          },
          {
            number: "02",
            ...
            reason:
              "<strong>Reason:</strong> This is equivalent to `__import__('os').listdir()`. It allows us to list the current directory contents.",
          },
          {
            number: "03",
            ...
            output: `['flag.txt', ...]`,
            reason:
              "<strong>Reason:</strong> Now we dig around and find the `flag.txt` file in the `/` directory. We use `chr(47)` to represent the forward slash `/` since it's blacklisted by the regex.",
          },
          {
            number: "04",
            ...
            output: `[Flag Content]`,
            reason:
              "<strong>Reason:</strong> We need to open and read the file. But remember we are restricted with the regex (`/` is blacklisted along with any 1-3 letters after a dot). So instead we use `chr()` again to thwart the regex blacklist. A more robust solution would be `__import__('builtins').open(chr(47)+'flag.'+chr(116)+'xt').read()`.",
          },
        ],
      },
      {
