        ...
        steps: [
          {
            ...
            output: "49",
            reason:
              "<strong>Reason:</strong> This confirms the vulnerability and rules out engines that do not use `{{...}}` syntax. It likely points to Jinja or Twig.",
          },
          {
            number: "02",
            ...
            output: "7777777",
            reason:
              "<strong>Reason:</strong> If it were Twig, it would output 49. The output `7777777` confirms Python is evaluating the expression, meaning the engine is Jinja. Running `{{self.__class__}}` verifies this by outputting<br> `&lt;class 'jinja2.runtime.TemplateReference'&gt;` .",
          },
        ],
      },
      {
        ...
        steps: [
          {
            ...
            output: "<class 'object'>",
            reason:
              "<strong>Reason:</strong> Starting with an empty string `''`, we access its class `str`, then its MRO tuple, and grab the base `object` class at index 1.",
          },
          {
            number: "02",
            ...
            reason:
              "<strong>Reason:</strong> We display all classes that inherit from `object`. We are looking for classes in `os` or `subprocess` modules. We find `subprocess.Popen` at index 356.",
          },
          {
            number: "03",
            ...
            output:
              "(b'__pycache__\\napp.py\\nflag\\nrequirements.txt\\n', None)",
            reason:
              "<strong>Reason:</strong> We instantiate `subprocess.Popen` to run the `ls` command. We see a file named `flag` in the output directory list.",
          },
          {
            number: "04",
            ...
            output: "[Flag Content]",
            reason:
              "<strong>Reason:</strong> Running the `cat flag` command through the Popen shell allows us to read the flag and solve the puzzle.",
          },
        ],
      },
      {
